...
export default function Home() {
  ...
  /**
   * fetchProposalById: fetch and parse one proposal from the DAO contract
   * Given the Proposal ID
   * and convert the returned data into a Javascript object with values we can use
   */
  ...
  /**
   * voteOnProposal: Calls the `voteOnProposal` function in the contract
  ...
  // and calls helper functions to fetch
